package br.com.siglabor.util.report;
...
public class ExecutorRelatorio implements Work {
	...
	public void execute(Connection connection) throws SQLException {
		try {
			//inputStream do java-io
			InputStream relatorioStream = (InputStream) this.getClass().getResourceAsStream(this.caminhoRelatorio);
